...
name 'math';
code_url 'https://github.com/duckduckgo/zeroclickinfo-goodie-math/blob/master/lib/DDG/Goodie/Math.pm';
category 'computing_tools';
topics 'math';


handle query_raw => sub {
    my $ffile = share('MathJax.js');
    my $html = '<script type="text/javascript"
                src="'.$ffile.'?config=TeX-AMS-MML_HTMLorMML">
